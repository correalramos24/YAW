...
class TestRunnerFactory(TestCase):
    def test_derive_1(self):
        info = {"type": "type","env_file": ["envA", "envB"]}
    ...
    def test_derive_2(self):
        info = {"type": "type","env_file": ["envA", "envB"],"log_name": ["logA", "logB"]}
        r = ConcreteRunner(**info)
    ...
    def test_derive_mirror(self):
        info = {"type": "type","env_file": ["envA", "envB"],"log_name": ["logA", "logB"], "mirror": 1}
        r = ConcreteRunner(**info)
    ...
    def test_derive_mirror_real(self):
        info = {"type": "type","env_file": ["envA", "envB"],"log_name": ["logA", "logB"], "mirror": 2}
        r = ConcreteRunner(**info)
        rr = RunnerFactory().derive(r)
