...
from py_utils.yaml_file import get_yaml_content
from py_utils.utils_py import inter_dict_keys, remove_keys, stringfy
from py_utils.meta import MetaAbstractClass

from yaw.core import AbstractRunner, BashRunner, VoidRunner
...
class RunnerManager(MetaAbstractClass):
    ...
    def __init__(self, input_files: list[Path], run_step_names: list[str]):
        ...
        self.steps: list[AbstractRunner | None] = [] # type: ignore
        self.steps_derived: list[AbstractRunner | None] = [] # type: ignore
